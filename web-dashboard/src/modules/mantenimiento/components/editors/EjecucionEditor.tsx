...
export default function EjecucionEditor({
  form,
  cambiar,
}: Props) {
  return (
    <Grid>
      ...
      <Check
        ...
        checked={form.equipo_detiene ?? false}
        onChange={(v) =>
          cambiar("equipo_detiene", v)
        }
      />
