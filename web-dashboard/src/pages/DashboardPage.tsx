              ...
              return (
                ...
                >
                  <div style={{
                    ...
                    background: isPrimary ? item.color : colors.surfaceMuted,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    margin: '0 auto 12px',
                  }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={isPrimary ? '#fff' : item.color} strokeWidth="2" strokeLinecap="round">
